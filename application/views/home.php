...
<html lang="en">
  <head>
    ...
    <!-- Author Meta -->
    <meta name="author" content="Robby Eka">
    <!-- Meta Description -->
    <meta name="description" content="Curriculum Vitae Robby Eka">
    <!-- Meta Keyword -->
            ...
            <div class="col-md-12 col-sm-12 text-center">
              <div class="contents">
                ...
                <ul class="social-icon wow fadeInUp" data-wow-delay="0.8s">
                  ...
                  <li>
                    <a class="twitter" href="#" target="_blank"><i class="icon-social-twitter"></i></a>
                  </li>
                  <li>
                    <a class="instagram" href="https://www.instagram.com/robbybrebet_/" target="_blank"><i class="icon-social-instagram"></i></a>
                  </li>
                  <li>
                ...
                <?php
                $str = "https://wa.me/6281233637701?text=Hallo *Robby*, Saya tertarik dengan CV kamu.";
